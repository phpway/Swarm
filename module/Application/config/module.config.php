...
return array(
        ...
        'factories' => array(
            ...
            'p4_admin' => function ($services) {
                if (MULTI_P4_SERVER && !strlen(P4_SERVER_ID)) {
                    throw new \Application\Connection\NoServerSelectedException;
                }

                $p4      = $services->get('p4_config');
            ...
            'projects_filter' => function ($services) {
                try {
                ...
                return new Application\Permissions\PrivateProjects($services->get('p4_admin'), $p4User);
            },
    ...
    'view_helpers' => array(
        'invokables' => array(
            'assetBasePath'     => 'Zend\View\Helper\BasePath',
