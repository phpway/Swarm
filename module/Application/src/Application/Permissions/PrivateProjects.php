...
class PrivateProjects
{
     ...
     * @param   ConnectionInterface|null    $p4User     connection of the user to determine acces to projects for
    ...
    public function __construct(ConnectionInterface $p4Admin, ConnectionInterface $p4User = null)
    {
        ...
        $this->isUserAdmin = $p4User ? $p4User->isAdminUser(true) : false;
    }
    ...
    public function filter(ModelIterator $items, $projectField = null)
    {
        ...
        // collect project ids from accross all items and pre-fetch project models at once to be a bit more effective
