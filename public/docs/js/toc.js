var sidebar_toc = {
  n: [
    { u: "index.html", t: "1.  Helix Swarm", n: [
      { u: "whatsnew.html", t: "What's new in 2016.2", n: [
    ...
    { u: "chapter.setup.html", t: "3.  Setting up", n: [
      ...
      { u: "setup.post.html", t: "Post-install configuration options", n: [
        { u: "setup.post.html#setup.post.ssl", t: "HTTPS" },
        { u: "setup.post.html#setup.post.subfolder", t: "Run Swarm in a sub-folder of an existing web site", n: [
          { u: "setup.post.html#setup.post.subfolder.apache", t: "Apache configuration" },
          { u: "setup.post.html#setup.post.subfolder.swarm", t: "Swarm configuration" },
          { u: "setup.post.html#setup.post.subfolder.cron", t: "Cron configuration" },
        ] },
        { u: "setup.post.html#setup.post.port", t: "Run Swarm's virtual host on a custom port", n: [
          { u: "setup.post.html#setup.post.port.apache", t: "Apache configuration" },
          { u: "setup.post.html#setup.post.port.cron", t: "Cron configuration" },
        ] },
      ] },
      { u: "setup.upgrade.html", t: "Upgrading Swarm", n: [
        { u: "setup.upgrade.html#setup.upgrade.2016.1", t: "Upgrade Swarm 2016.1 to 2016.1 SP1" },
    ...
    { u: "chapter.basics.html", t: "4.  Basics", n: [
      ...
      { u: "basics.projects.html", t: "Projects", n: [
        ...
        { u: "basics.projects.html#basics.projects.private", t: "Private projects", n: [
          { u: "basics.projects.html#basics.projects.private.important", t: "Caveats" },
        ] },
      ] },
    ...
    { u: "chapter.code_reviews.html", t: "7.  Code reviews", n: [
      { u: "code_reviews.model.html", t: "Models", n: [
        ...
        { u: "code_reviews.model.html#code_reviews.model.internal", t: "Internal representation", n: [
          { u: "code_reviews.model.html#code_reviews.model.internal.changelists", t: "Swarm-managed changelists" },
          { u: "code_reviews.model.html#code_reviews.model.internal.workspaces", t: "Swarm-managed workspaces", n: [
            { u: "code_reviews.model.html#code_reviews.model.internal.workspaces.removal", t: "Removal considerations" },
          ] },
        ] },
      ] },
    ...
    { u: "chapter.administration.html", t: "9.  Administration", n: [
      ...
      { u: "admin.environment.html", t: "Environment", n: [
        ...
        { u: "admin.environment.html#admin.environment.external_url", t: "external_url" },
        { u: "admin.environment.html#admin.environment.base_url", t: "base_url" },
      ] },
      ...
      { u: "admin.swarm_root.html", t: "swarm_root" },
    ...
    { u: "chapter.extending.html", t: "10.  Extending Swarm", n: [
      ...
      { u: "extending.clients.html", t: "CSS &amp; JavaScript", n: [
        { u: "extending.clients.html#extending.clients.javascript", t: "Sample Javascript extensions", n: [
          { u: "extending.clients.html#extending.clients.javascript.created", t: "Make the Created column on the Reviews page clickable" },
          { u: "extending.clients.html#extending.clients.javascript.morecontext", t: "Adjust the number of \"more context\" lines for diffs" },
          { u: "extending.clients.html#extending.clients.javascript.reviewstate", t: "Customize the review state options text" },
        ] },
        { u: "extending.clients.html#extending.clients.css", t: "Sample CSS customizations", n: [
          { u: "extending.clients.html#extending.clients.css.tabsize", t: "Adjust the default tab size" },
          { u: "extending.clients.html#extending.clients.css.loginbg", t: "Apply a custom background to the login screen" },
          { u: "extending.clients.html#extending.clients.css.navbar_logo", t: "Replace Swarm's logo in the main navigation bar" },
          { u: "extending.clients.html#extending.clients.css.avatar", t: "Adjust the appearance of avatars" },
        ] },
      ] },
    ] },
    { u: "api.html", t: "11.  Swarm API", n: [
      { u: "api.endpoints.html", t: "API Endpoints", n: [
        { u: "api.endpoints.html#api.endpoints.Activity", t: "Activity : Swarm Activity List", n: [
          { u: "api.endpoints.html#api.endpoints.Activity.listActivity", t: "GET /api/v4/activity", n: [
          ...
          { u: "api.endpoints.html#api.endpoints.Activity.addActivity", t: "POST /api/v4/activity", n: [
        ...
        { u: "api.endpoints.html#api.endpoints.Comments", t: "Comments : Swarm Comments", n: [
          { u: "api.endpoints.html#api.endpoints.Comments.getComments", t: "GET /api/v4/comments/", n: [
            { u: "api.endpoints.html#api.endpoints.Comments.getComments.notes", t: "Description" },
            { u: "api.endpoints.html#api.endpoints.Comments.getComments.parameters", t: "Parameters" },
            { u: "api.endpoints.html#api.endpoints.Comments.getComments.successExamples", t: "Examples of successful responses" },
            { u: "api.endpoints.html#api.endpoints.Comments.getComments.usageExamples", t: "Examples of usage" },
          ] },
          { u: "api.endpoints.html#api.endpoints.Comments.addComment", t: "POST /api/v4/comments/", n: [
            { u: "api.endpoints.html#api.endpoints.Comments.addComment.notes", t: "Description" },
            { u: "api.endpoints.html#api.endpoints.Comments.addComment.parameters", t: "Parameters" },
            { u: "api.endpoints.html#api.endpoints.Comments.addComment.successExamples", t: "Successful Response contains Comment entity:" },
            { u: "api.endpoints.html#api.endpoints.Comments.addComment.usageExamples", t: "Examples of usage" },
          ] },
          { u: "api.endpoints.html#api.endpoints.Comments.editComment", t: "PATCH /api/v4/comments/{id}", n: [
            { u: "api.endpoints.html#api.endpoints.Comments.editComment.notes", t: "Description" },
            { u: "api.endpoints.html#api.endpoints.Comments.editComment.parameters", t: "Parameters" },
            { u: "api.endpoints.html#api.endpoints.Comments.editComment.successExamples", t: "Successful Response contains Comment entity:" },
            { u: "api.endpoints.html#api.endpoints.Comments.editComment.usageExamples", t: "Examples of usage" },
          ] },
        ] },
        { u: "api.endpoints.html#api.endpoints.Groups", t: "Groups : Swarm Groups", n: [
          { u: "api.endpoints.html#api.endpoints.Groups.listGroups", t: "GET /api/v4/groups/", n: [
          ...
          { u: "api.endpoints.html#api.endpoints.Groups.getGroup", t: "GET /api/v4/groups/{id}", n: [
          ...
          { u: "api.endpoints.html#api.endpoints.Groups.createGroup", t: "POST /api/v4/groups/", n: [
          ...
          { u: "api.endpoints.html#api.endpoints.Groups.patchGroup", t: "PATCH /api/v4/groups/{id}", n: [
          ...
          { u: "api.endpoints.html#api.endpoints.Groups.deleteGroup", t: "DELETE /api/v4/groups/{id}", n: [
        ...
        { u: "api.endpoints.html#api.endpoints.Index", t: "Index : Basic API controller providing a simple version action", n: [
          { u: "api.endpoints.html#api.endpoints.Index.version", t: "GET /api/v4/version", n: [
        ...
        { u: "api.endpoints.html#api.endpoints.Projects", t: "Projects : Swarm Projects", n: [
          { u: "api.endpoints.html#api.endpoints.Projects.listProjects", t: "GET /api/v4/projects/", n: [
          ...
          { u: "api.endpoints.html#api.endpoints.Projects.getProject", t: "GET /api/v4/projects/{id}", n: [
          ...
          { u: "api.endpoints.html#api.endpoints.Projects.createProject", t: "POST /api/v4/projects/", n: [
            ...
            { u: "api.endpoints.html#api.endpoints.Projects.createProject.usageExamples", t: "Examples of usage" },
          ] },
          { u: "api.endpoints.html#api.endpoints.Projects.patchProject", t: "PATCH /api/v4/projects/{id}", n: [
            ...
            { u: "api.endpoints.html#api.endpoints.Projects.patchProject.usageExamples", t: "Examples of usage" },
          ] },
          { u: "api.endpoints.html#api.endpoints.Projects.deleteProject", t: "DELETE /api/v4/projects/{id}", n: [
        ...
        { u: "api.endpoints.html#api.endpoints.Reviews", t: "Reviews : Swarm Reviews", n: [
          { u: "api.endpoints.html#api.endpoints.Reviews.getReviews", t: "GET /api/v4/reviews/", n: [
          ...
          { u: "api.endpoints.html#api.endpoints.Reviews.getReview", t: "GET /api/v4/reviews/{id}", n: [
          ...
          { u: "api.endpoints.html#api.endpoints.Reviews.createReview", t: "POST /api/v4/reviews/", n: [
          ...
          { u: "api.endpoints.html#api.endpoints.Reviews.addChange", t: "POST /api/v4/reviews/{id}/changes/", n: [
          ...
          { u: "api.endpoints.html#api.endpoints.Reviews.state", t: "PATCH /api/v4/reviews/{id}/state/", n: [
      ...
      { u: "api.example.html", t: "Extended API example", n: [
        { u: "api.example.html#api.example.code", t: "The code" },
        { u: "api.example.html#api.example.execution", t: "Executing the example" },
      ] },
    ] },
